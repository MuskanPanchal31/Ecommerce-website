...
from app.models import slider,Bannerarea,Main_Category,Product,Category,Color,Brand,Coupon_Code
...
def REGISTER(request, password=None, email=None):
...
def PROFILE_UPDATE(request):
    if request.method == "POST":
        ...
        if password != None and password != "":
            user.set_password(password)
        user.save()
        messages.success(request, " Profile are Sucessfully Updated !!!")
...
def filter_data(request):
    ...
    product_num=request.GET.getlist('product-num[]')
...
def Wishlist(request):
    return render(request,'includes/wishlist.html')
